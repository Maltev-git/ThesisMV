...
Because of the CMEs' possible strong impact on the terrestrial magnetosphere it is important to know their arrival time at Earth in advance.

Knowing the geometry of a CME, it is possible to infer its direction and speed from white-light images. Through kinematic forward-modeling techniques that take advantage of the self-similar expansion observed in CMEs, it is possible to derive an estimated arrival time at Earth.\\
