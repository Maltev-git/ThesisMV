...
As the probability that the magnetic topology of an active region conforms to the hemispheric rule is greater than \SI{80}{\percent} \citep{Wang2013}, a MC configuration predicted with the BSS is expected to have a reliability that is of the same order \citep{Savani2015}.\\
