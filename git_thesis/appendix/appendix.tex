...
A wise choice of coordinate system often eases the understanding and the calculation of a given problem, especially in geo- and astrophysics there exist an abundance of different coordinate systems.\\

In the following, the coordinate systems used in this thesis are described. I use 
GSE coordinates for the sw plots in the basics\\
GSM coordinates throughout chapter2\\
HGI coordinates for Helios chapter\\
