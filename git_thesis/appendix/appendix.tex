...
\end{align}
with $t$ in years, suffices for the plot of the seasonal changes in Earth's solar distance presented in \autoref{fig:Sun_Earth_geometry_gps}.
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.6\textwidth]{figures_of_mine/gnuplots/Sun_Earth_geometry_gps.pdf}
	}{
		...
		\label{fig:Sun_Earth_geometry_gps}
	}
\end{figure}
The distance variation has implications for the magnitude of the solar wind quantities measured at Earth, as most of them follow a power law distance dependency.
...
Astronomical unit: $\SI{1}{\au} = \SI{149597870.700}{\km}$ \citep{USNO2015}\\ %Astronomical constants
Solar mass: $M_\odot = \SI{1.9884(2)e30}{\kg}$ \citep{USNO2015}\\ %see also Mamajek2015
Nominal solar radius (photosphere): $R_\odot = \SI{695700}{\km}$ \citep{Mamajek2015}\\ %Astronomical constants
Solar rotation axis tilt: $i_\odot = \SI{7.25}{\degree}$ \citep{USNO2015}\\ %C3; Obliquity to ecliptic
...
NASA maintains the Planetary~Fact~Sheets online\footnote{NASA Planetary Fact Sheets website: \urlfoot{https://nssdc.gsfc.nasa.gov/planetary/planetfact.html}}.\\
