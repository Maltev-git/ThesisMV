...
The true skill score (TSS) is a measure for...\\
...
% calculate skill score table
% generic contingency table
% hits		false alarms
% misses	correct nulls
% 
% f/c
% 	Y	N
% Y	YY	YN
...
% 
% true skill score
% TSS=(x*w-y*z)/((x+y)*(z+w))=H-F
% hit rate H
% false alarm rate F
% It does express the hit rate relative to the false alarm rate, and will remain positive as long as H is greater than F.
% 
% chance hits
% ch=((x+y)*(x+z))/(w+x+y+z)
