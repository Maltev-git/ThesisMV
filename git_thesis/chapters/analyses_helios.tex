...
Solar wind magnetic field model of \citet{Parker1958} with its components in spherical coordinates ($\theta$ is the co-latitude):
\begin{align}
...
at 1 au the observed field angle in the ecliptic $\phi$ is about \SI{45}{\degree} ($B_r = B_\phi$, thus $B(1 au) = B_0 \cdot \sqrt{2}$). see OMNI plot and calculate omega from equation with typical values...\\
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\textwidth]{images/gnuplots/radial_fit_B_test2.png}
...
\begin{table*}
	...
	\begin{tabular}{l c c c c}
		...
		\cline{3-4}
			&$a$	&$e_1$	&$e_2$	&[au]\\
		\hline
		Median	&4.04(13)	&-1.852(25)	&-0.97(23)	&\multirow{2}{*}{0.33625(??)}\\
...
make 2d-fit\\
at \SI{0.046}{\au} the value is ?? nT. This is higher than the value in the paper.\\
