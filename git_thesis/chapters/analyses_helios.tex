...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		\caption{Frequency distributions of the solar-wind magnetic field strength (OMNI data) and those estimated with the solar-wind model for PSP's 1st and 22nd (first closest) perihelion. In this plot the frequencies of both extrapolated curves are scaled for visibility to the same height as the \SI{1}{\au} distribution. I indicated the prediction from \citet{Venzmer2017} is as well (dotted lines).}
