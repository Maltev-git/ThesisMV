...
coauthor is Volker~Bothmer\\
The major part of this chapter is published in citet{Venzmer2017}. This paper is inluded following this chapter. not yet reproduced with permission \textcopyright~ESO.\\
copyright/published in Astronomy and Astrophysics\\

The described analyses were entirely done by me, as well as the tables, figures and equations. My coauthor worked together with me on the text and the anonymous referee helped clarifying the descriptions of a few aspects. The text was further improved by the A\&A language editor Joshua~Neve.\\
