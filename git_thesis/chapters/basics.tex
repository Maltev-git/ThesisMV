...
\begin{itemize*}
	...
	\item Induced changes in the stratification of the ionosphere (D-, E-, and F"~layers) disturb radio communication and lead to outages in various frequency bands.
\end{itemize*}
