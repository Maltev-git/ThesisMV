...
\begin{itemize*}
	...
	\item solar wind nowcast: \Kp--E"~field relation (average and worst case)
...
One has to choose between the high accuracy of the L1-derived \Kp{} nowcast with a short lead time and the lower accuracy of the remotely derived \Kp{} forecasts with fairly long lead times.\\
...
The present study adds more empirical \Kp{} relations -- for the cases when only the solar wind velocity $v$ or its electric field \vBz{} are known. The derived \Kp{} relations are part of the UGOE/IAG CME forecast chain.\\
