...
% a 0.281126         +/- 0.04267
% b 1.04923          +/- 0.19
which is plotted together with its fit error band in \autoref{fig:Kp_SSN_fit_d}. This means that for an average yearly SSN of 1 the mean \Kp{} is $1.05(20)$ and for a SSN of 300 it is $2.65(31)$. The errors are calculated via error propagation from the estimated standard deviations of the fit parameters.
% SSN	Kp	Kp_err
% 1	1.0492	0.189
% 10	1.6965	0.213
% 50	2.1489	0.252
...
\begin{figure}[htb]
	...
	\caption[\lofimage{figures_of_mine/chapter2/example_sw_plot_1month_b_2013-5-1_65.pdf}I created the figure myself.]
...
\begin{figure}[htb]
	...
	\caption[\lofimage{figures_of_mine/chapter2/example_sw_plot_CME_b_2013-6-26_6.pdf}I created the figure myself.]
