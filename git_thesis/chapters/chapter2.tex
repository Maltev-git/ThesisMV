...
\Kp{} forecast from remote CME and stream observations...\\
...
The different CME and stream forecast methods are described in \autoref{sec:stream_and_cme_forecast_to_earth}.\\

% velocity as coupling function
The IMF strength and orientation is difficult to determine from remote observations. The solar wind velocity is the only coupling parameter which is to a certain degree reliably forecastable. Therefore, the heads-up time of remote observations can be made still use of.\\
