...
There are differences in magnitude and trend in the \Kp--velocity prediction curves obtained from CMEs and streams. This confirms that it is beneficial to utilize separate relations for the prediction of \Kp{} from CME and stream velocities.
