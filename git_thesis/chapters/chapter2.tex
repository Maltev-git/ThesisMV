...
% comparison
The E"~field model has a TSS of 0.33 at a \Kp{} of 5 and can be compared with the Wing APL model~3 \citep[Fig.~13]{Wing2005}. The Wing APL model~3 predicts \Kp{} 1~hour in advance and uses the solar wind parameters $n, v_\text{x}, |\vect{B}|$, and $B_\text{z}$ as input sources for a neural network. The additionally considered parameters density and magnetic field strength boost the corresponding TSS to about 0.7.\\
