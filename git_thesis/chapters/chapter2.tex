...
\begin{figure}
	\fcapside[\FBwidth]{
		...
		{Prediction performance of \Kp{} persistence and the three derived empirical \Kp{} relations. These forecast errors are calculated from the same data and time range as the relations themselves. The errorbars denote one positive and negative standard deviation. Perfect predictions are indicated by the gray lines.}
...
\begin{figure}
	\fcapside[\FBwidth]{
		...
		\caption{True skill scores for the three relations as a function of \Kp{} threshold. The persistence of the previous \Kp{} value is indicated by the black line.}
