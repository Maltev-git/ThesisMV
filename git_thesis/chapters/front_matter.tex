...
\begin{small}
	\noindent The electronic version of this document is fully hyperlinked. The external links in some figure captions and in the references are not accessible in the printed version.
	All linked web pages in this document were existent and all external web links in this document were valid in 2018-XX-XX.
\end{small}
...
334	2018-07-15	implement offline comments\\
\vspace{\baselineskip}
...
\begin{abstract}
	...
	\noindent This thesis derives empirical predictions of the solar wind's and coronal mass ejections' impact on the terrestrial magnetosphere and of the solar wind environment in the near-Sun region.
