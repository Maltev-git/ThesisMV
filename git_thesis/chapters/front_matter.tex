...
% 	\noindent \textit{Context.} 
	...
	%solar activity
	Furthermore, the key solar wind parameters magnetic field strength, proton velocity, density, and temperature are correlated with the sunspot number for the purpose of deriving functional dependencies with the state of the solar cycle. The solar wind data consists of 53~years from the hourly OMNI data set.
	%solar distance
