...
The reconnection in the magnetotail occurs in regular intermittent reconnection bursts, called substorms. They can produce plasmoids that release from the tail and are swept away with the solar wind. Substorms are the major nightside flux closure process and occur frequently every few hours \citep{Milan2007}. Their duration varies greatly around an average value of \SI{70}{\minute}. Substorms vary greatly in intensity and create sudden brightenings and increased activity in the aurora. Substorms are found to occur spontaneously during southward IMF periods, however, in \SI{60}{\percent} of the cases they are triggered by changing upstream solar wind conditions -- either by switches in the IMF orientation or by shocks in the solar wind ram pressure \citep{Milan2007}.\\
