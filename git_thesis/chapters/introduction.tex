...
In order to relate the coupling functions to geomagnetic indices, relations are obtained by empirically fitting both time series. As the \Kp~index is the measure for the size of geomagnetic disturbances, \\
...
Kp empirical functions making use of coupling functions...\\
