...
half-wave rectifier compared to Newell's IMF clock angle factor, see \autoref{fig:figures_of_mine/gnuplots/coupling_angle}\\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.6\textwidth]{figures_of_mine/gnuplots/coupling_angle.png}
	}{
		\caption[\lofimage{figures_of_mine/gnuplots/coupling_angle.png}]
		{IMF clock angle ($\theta_c$) dependency of the coupling functions' relative amplitudes. I plotted Newell's relation (black) and the half-wave rectifier (purple).}
		\label{fig:figures_of_mine/gnuplots/coupling_angle}
	}
\end{figure}
