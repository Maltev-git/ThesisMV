...
A period of solar wind, measured in~situ by the ACE spacecraft at the first Lagrange point 
(L1), is plotted in \autoref{fig:ACE_64s_v7_thesis_2013-5-1_65_plot}.\\
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{images/gnuplots/ACE_64s_v7_thesis_2013-5-1_65_plot.pdf}
	\caption{Solar wind parameters at L1 during the time period 1~May to 5~June in 2013. The parameters are the magnetic field strength, its field angle in the ecliptic in GSE~coordinates, the proton velocity, density, and temperature. In the velocity panel also the field polarity is color coded -- assuming a Parker spiral angle of \SI{-45}{\degree}. Blank periods indicate bad or missing data. The data was measured with the MAG and SWEPAM instruments onboard the ACE spacecraft and is obtained from the ACE~Science~Center web interface\protect\footnotemark. indicate structures...}
	\label{fig:ACE_64s_v7_thesis_2013-5-1_65_plot}
\end{figure}
...
Recurrent HSSs of the same field polarity but changing peak velocity exist in this period (e.g., beginning on 6~May, 2~June, and 29~June). They are preceded by CIRs containing sector boundaries. CMEs passed on 7?~June, XXX... The 7?~June CME is displayed in higher details in figure XX...\\
...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.6\textwidth]{images/gnuplots/CME_ace_realtime_ap_CH_GFT_plot.png}
	}{
		\caption{Solar-wind in-situ measurements wich show a CME with a MC. B, v, n, and T. ACE data. remake figure...}
		\label{fig:CME_ace_realtime_ap_CH_GFT_plot}
	}
\end{figure}
...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		\caption{Solar-wind in-situ measurements wich show the MC of the CME. B, Bz (GSM), Bphi (GSM, and Kp. ACE, Dst, and Kp data. redo figure...}
		\label{fig:MC_CME_ace_realtime_ap_CH_GFT_plot}
	}
\end{figure}
