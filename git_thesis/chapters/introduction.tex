...
intercalibrated multi-spacecraft OMNI data coverage (see also talk 2014-02-18), see \autoref{fig:timeline_OMNI_SC_IDs_}\\
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{images/gnuplots/timeline_OMNI_SC_IDs_.pdf}
	\caption{Low Resolution OMNI (LRO) data spacecraft coverage. integrate into 1 panel...}
	\label{fig:timeline_OMNI_SC_IDs_}
\end{figure}

HRO s/c coverage figure...\\
make LRO, HRO, Helios, PSP, Kp, SSN overview timeline...\\
