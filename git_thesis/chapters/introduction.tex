...
%%% various indices
Several indices were defined for measuring variations in different parts of the geomagnetic system.\\
The International Service of Geomagnetic Indices (ISGI) lists the following indices: ...\\
...
\Kp{} is calculated from local \textit{K} indices...\\
