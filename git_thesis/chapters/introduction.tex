...
\begin{figure}[htb]
	...
	\fcapside[\FBwidth]{
		...
		\caption{Total solar eclipse image of the inner corona up to 5~solar radii. The picture was taken in Mongolia, 1~August~2008 and is processed from multiple images. Visible are the for a quiet Sun in cycle minimum typical magnetic field's dipole structure and the equatorial streamer belt. Replicated with permission from \href{http://www.zam.fme.vutbr.cz/~druck/Eclipse/}{Miloslav Druckmüller, Peter Aniol, Jan Sládeček}, 2008.}
...
\begin{figure}[htb]
	...
	\fcapside[\FBwidth]{
		...
		\caption{Schema of the heliosphere and its surrounding flow structure. The heliosphere is formed by the interaction of the solar wind with the local interstellar medium at the heliopause. \citep[Fig.~9]{Owens2013}}
...
% Hi, there!
% My question concerns the poloidal solar magnetic field during cycle minimum. I understand the generation of the polar surface fields in the steps from a) to d) in the last figure on the page http://solarcyclescience.com/solarcycle.html. However, does the toroidal field in the interior disappear during cycle minimum (from panel c) to d))? There seems to be a step missing in my understanding of the way from panel d) back to a). How can there be a poloidal field in the solar interior whith the continuous differential rotation in place and how can it even be generated? As I understand, there can only exist fields in the convection zone and overshoot region -- not in the core or radiation zone, right?
...
\begin{figure}[htb]
	\begin{floatrow}
		\ffigbox{
			...
			\caption{Solar magnetic field geometry from the DQCS model with field lines (solid) and constant field strength surfaces (dashed). The quadrupole part allows equatorial outflows along the current sheet. \citep[Fig.~3 in][reproduced with permission \textcopyright~ESO.]{Banaszkiewicz1998}}
			\label{fig:Banaszkiewicz1998_DQCS_model_raw}
		}
		\ffigbox{
			\includegraphics[width=\Xhsize]{images/Owens2013_PFSS_Sectors_screenshot.png}
		}{
			\caption{Illustration of the solar magnetic field Parker spiral formation by rotation of the solar wind source surface. Between solar wind flows of opposite magnetic field polarity a heliospheric current sheet (HCS) forms. (\citet[Fig.~1]{Owens2013}, adapted from \citet[Fig.~1]{Schatten1969})}
...
\begin{figure}[htb]
	...
	\fcapside[\FBwidth]{
		...
		\caption{Schema of the formation of a stream interface (left) and deflection of streams (right), both generated from interactions between slow and fast solar wind. (\citet[Fig.~7]{Owens2013}; right panel adapted from \citet[Fig.~2]{Pizzo1991})}
...
\begin{figure}[htb]
	...
	\fcapside[\FBwidth]{
		...
		\caption{reconnection and compression depending on the interplanetary magnetic field orientation; figure~4.8 from \citet[p.~116]{Bothmer1998}, adapted from Dungey1961, 1963. get permission... accelerated flows are arrowed; N points are X points...}
