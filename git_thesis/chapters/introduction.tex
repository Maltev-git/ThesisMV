...
\begin{itemize*}
	...
	\begin{align}
		...
		|\vect{E}| &= E_\text{y} = -v_\text{x} \cdot B_\text{z}	\,.	\label{eq:coupling_vxBz}
	\end{align}
	...
	\end{align}
	figure...?\\
	\item The Newell relation \citep{Newell2007}.
\end{itemize*}
...
Because Bs is discontinuous in slope around Bs = 0, a form such as B sin**4(theta/2) is often preferred, where the IMF “clock angle”. This has a very similar form to Bs at large |Bs| but is continuous in slope around zero.\\
...
there are functions approximating the reconnection rate depending on the clock angle\\
...
The rate magnetic flux is opened at the magnetopause $\text{d}\Phi / \text{d}t$.\\
...
half-wave rectifier compared to Newell's IMF clock angle factor, see \autoref{fig:figures_of_mine/gnuplots/coupling_angle_b}\\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		\label{fig:figures_of_mine/gnuplots/coupling_angle_b}
	}
\end{figure}
