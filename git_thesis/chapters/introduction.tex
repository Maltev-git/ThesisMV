...
Solar wind injects plasma and energy into the magnetosphere, varying the number of particles in the magnetospheric equatorial current system. When this ring current is increased, it generates an enhanced magnetic field of opposite polarity to the magnetospheric field. This leads to a decrease in the local terrestrial magnetic field.\\

The decrease is measured by the disturbance storm time $Dst$~index, which measures the magnetic field at the dipole equator on the Earth's surface and thus represents the intensity of the ring current.\\

Major negative disturbances in the $Dst$~index define geomagnetic storms, that is, if $Dst$ reaches values less than -50? (cite?). Geomagnetic storms last a few hours, but the duration for recovery can take up to several days.\\

average and maximal storm $Dst$ values...\\

Positive $Dst$ disturbances occur during compression of the magnetosphere due to increased solar wind pressure.\\
