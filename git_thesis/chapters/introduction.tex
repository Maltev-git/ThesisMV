...
% Kp index
However, for the assessment of overall geomagnetic activity, another index has been more widely used than $Dst$, the \Kp{}~index \citep{Gonzalez1994}. Now, \Kp{} is the basis for NOAA's G"~Scale\footnote{NOAA Space Weather Scales website: \urlfoot{https://www.swpc.noaa.gov/noaa-scales-explanation}} that describes the severity of geomagnetic storms.
...
see also \autoref{sec:kp_data}.\\
more about Kp...\\
location of Kp observatories... and intent to measure sw influence...\\
...
The timing and intensity of geomagnetic storms is sought to be foercasted from knowledge about the upcoming solar wind conditions. This means that there are two unknowns: how does the magnetized solar wind plasma couple to the magnetosphere and which solar wind will arrive at the magnetopause?\\

In technical terms: as the \Kp~index is the measure for the size of geomagnetic disturbances, a function relating \Kp{} to solar wind quantities is needed.\\
