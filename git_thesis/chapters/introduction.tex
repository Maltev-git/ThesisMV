...
There exist a lot more aspects/properties related to the solar wind, i.e., MHD waves, electron pitch angle, solar energetic particles, dust particles, and neutral energetic atoms. Yet, they are not covered here, because they are not of relevance to the analyses in this work.\\
...
% shocks
The plasma pressure inside CIRs is increasing with heliocentric distance and therefore the leading and trailing compressional waves form into shocks and reverse shocks -- typically at solar distances between \SIrange{2}{10}{\au} \citep{Smith1976,Balogh2009}.
% deflections
The spiral shape of the stream interfaces and their inclination to the solar rotation axis lead to the deflection of both streams \citep{Balogh2009}. Due to the fast and slow streams' collision, the fast wind is decelerated and the slow wind is accelerated and their flow directions are systematically deflected away from the interface as shown in the right panel of \autoref{fig:Owens2013_CIR_2panel_screenshot}.\\




% HCS connection
As a consequence of the relationship between the HCS and the coronal streamer belt, the HCS is located at the centre of the slow solar wind band near the Sun. Indeed, the HCS is often observed to be embedded within SIRs and CIRs (Gosling and Pizzo, 1999). As the forward wave/shock propagates into the slow solar wind ahead of a CIR it can eventually overtake the HCS boundary, making it more likely for the HCS to be embedded within a CIR with increasing distance from the Sun (Thomas and Smith, 1981). \citet{Owens2013}\\

% MIRs
As the CIRs move outwards, they coalesce into larger scale, merged structures (the so-called Merged Interaction Regions, or MIRs) from about 10 AU (Burlaga1985).\\

As CIRs propagate from the inner heliosphere, they widen to cover a larger radial distance between their leading and trailing edges; thus CIRs catch up with preceding CIRs and merging occurs (Burlaga et al. 1984; Whang and Burlaga 1985; Smith 1989). This phenomenon manifests itself in the coalescence of the interaction regions, resulting in fewer, but more intense compression regions beyond 10 AU \citep{Balogh2009}.\\

The solar wind is dynamically compressed into narrow merged interaction regions; the magnetic field magnitude is similarly compressed \citep{Balogh2009}\\

Similar results, with merged CIRs recurring at the rate of one per solar rotation were observed by the Voyager spacecraft at these heliocentric ranges (Burlaga et al. 1997).\\


% in-situ signatures of SIRs
describe in-situ signatures of CIRs; in-situ solar-wind plot, see \autoref{fig:ACE_64s_v7_thesis_CIRs_2013-5-1_65_plot}\\
Recurrent HSSs are preceded by CIRs containing sector boundaries.\\

The pressure is higher within the CIR bounded by the two shock waves than in the preceding or following solar wind plasma. At the forward shock, the solar wind speed and density and the magnetic field increase abruptly; at the reverse shock, the speed increases, but the density and the magnetic field intensity decrease. \citep{Balogh2009}\\

Within the interaction region the magnetic field intensity and plasma density are enhanced by compression. \citet{Owens2013}\\
