...
\end{figure}
\footnotetext{ACE Science Center website: \urlfoot{http://www.srl.caltech.edu/ACE/ASC/}}
...
\begin{figure}[htb]
	\begin{floatrow}
		...
		\ffigbox[\Xhsize]{
			...
			\caption{Solar distance (top) and heliolatitude (middle) of both Helios probes with respect to their mission time. The SIDC 13-month smoothed monthly SSN is plotted in the bottom panel. make SSN grey...}
