...
It is observed that the continuous solar wind comes in streams roughly focused at two major velocity ranges \citep{Neugebauer1966,Schwenn1983}, slow streams around \SIrange{250}{450}{\km\per\s} and fast streams around \SIrange{450}{800}{\km\per\s} respectively.\\

see paper...\\
They have different characteristics and compositions.\\

%mechanisms
McGregor2011 analyzed the empirical magnetic topology–velocity relationship, using Helios perihelion data with the Wang-Sheeley-Arge (WSA) coronal model, and found indications, that the fast and slow solar wind are generated from distinct mechanisms. (not only superradial expansion)\\

slow wind sources still under debate\\

%sources of fast wind
Corona observations, made by the first space-based coronagraph located on Skylab in 1973/74, showed that the fast solar wind emerges from coronal holes \citep{Krieger1973,Hundhausen1977}.\\
regions with open field lines -> coronal holes -> fast sw/high speed streams\\




fast wind emerges from CHs\\
slow wind comes from closed field streamers; different sources...\\

%sources of slow wind
regions with closed lines (trapped plasma) -> slow solar wind/streamers\\
