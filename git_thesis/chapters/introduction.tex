...
\begin{itemize*}
	\item The Wing \Kp{} models have 1- and 4"~hour predictions. They are based on neural network models that take as input the solar wind real-time measurements made at L1 and the current \Kp{} nowcast \citep{Wing2005}. The model is provided by the U.S. Air Force Weather Agency and hosted at NOAA/SWPC: \urltext{https://www.swpc.noaa.gov/products/wing-kp}.

	\item Kp quicklook, GFZ~Potsdam
	\item Aleksei's f/c model; Ukraine
	\item Newell's coupling relation is being implemented into forecast procedures \citep{Savani2017}.
