...
seasonal effects from Earth orbital distance, inclination (solar rotation axis angle) and Earth tilt (see \autoref{fig:Hundhausen1977_fig20bcd} and \autoref{fig:fig1_cut})\\
\begin{figure}[htb]
	\centering
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\textwidth]{figures_of_others/images/fig1_cut.png}
	\caption[\lofimage{figures_of_others/images/fig1_cut.png}]
	{Magnetosphere geometry in the plane orthogonal to the ecliptic. get new figure... get permission... use Nichols2016 or Milan2009 instead or in addition?}
	\label{fig:fig1_cut}
\end{figure}
...
\subsection{Solar-wind coupling to the magnetosphere}
\label{sec:solar_wind_coupling_to_the_magnetosphere}
...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		{Schema of the magnetosphere with emphasis on open (blue lines) and closed (red lines) magnetic flux. The magnetopause is indicated by the dashed line. The opening flux rate at the dayside is denoted with $\Phi_\text{D}$ and closing at the nightside with $\Phi_\text{N}$. The inset shows day- and nightside of the Earth and the relation between auroral ovals (yellow areas) and the open flux at the polar caps ($F_\text{PC}$). The ring current (green arrow) intensity $H_\text{SYM}$. Credit: {\citet[Fig.~1]{Milan2009}}, \textcopyright~American Geophysical Union, reproduced with permission.}
