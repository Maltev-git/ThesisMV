...
CIR and HSS, see \autoref{fig:SIR_HSS_2013-07-21_210701}\\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.6\textwidth]{images/gnuplots/SIR_HSS_2013-07-21_210701.png}
	}{
		\caption{slow wind and HSS with C?IR. ACE data. remake figure...}
		\label{fig:SIR_HSS_2013-07-21_210701}
	}
\end{figure}
