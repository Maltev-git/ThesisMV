...
https://arxiv.org/pdf/1602.03665.pdf\\
...
% CME sources
active regions:\\
sunspots, magnetic reconnections, flares, post-eruptive arcades, coronal dimming\\
...
CME models: GCS, cone, etc.; conception of 3-dim CME shape --> enables Earth arrival time forecast from modeled direction and velocity\\
...
%early CME deceleration\\
The results by \citet{Sachdeva2017} indicate that due to solar-wind drag, the speeds of fast CMEs will commonly slow down substantially from early distances of a few solar radii. paperMVVB\\
...
interaction with IMF, solar wind, shocks, SEPs, interplanetary radio bursts\\

CME-plasma properties\\

There is considerable evidence to support the idea that all ICMEs may be flux ropes (Marubashi1997; Owens2005; Gopalswamy2006; Riley et al. 2006; Gopalswamy et al. 2013a; \citep{Vourlidas2013}; Marubashi et al. 2015).\\


% MCs
magnetic clouds (MCs)\\
MC vs magnetic flux ropes (MFR)?\\
Bothmer-Schwenn scheme (BSS), \citep{Bothmer1998}: they proposed a scheme that predicted the magnetic topology based on two parameters: whether the solar cycle number is even or odd and whether the CME originated in the Northern or Southern Hemisphere.\\
