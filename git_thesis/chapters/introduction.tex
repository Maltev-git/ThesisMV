...
%%% Parker spiral
The solar-wind source surface rotates with the Sun and thus shears the heliospheric magnetic field (HMF) into an Archimedean spiral pattern, adding an azimuthal component to the radial HMF. This geometry was anticipated by \citet{Parker1958} and is now called Parker spiral. Commonly the HCS looks more like a ballerina skirt, due to magnetic field variations, and thus the Parker spiral has regions composed from different magnetic polarity, separated by the HCSs. \autoref{fig:Owens2013_PFSS_Sectors_screenshot} shows the Parker spiral viewed in the ecliptic plane, where the solar rotation axis tilt (of xx degree) leads to a slight diving into both hemispheres of opposite polarity.\\
