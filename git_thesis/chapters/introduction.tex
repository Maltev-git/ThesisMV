...
\subsection{Solar-wind coupling}
...
% magnetosphere
% structure
% Solar-wind coupling mechanisms (reconnection, turbulence, ...)
% current sheets, currents, plasma regions
% Dungey convection cycle (Bz; unsteady/continuous reconnection; substorms; two-cell convection)
% seasonal variations (R-M effect)
% Geomagnetic storms
% 
% Geomagnetic indices
% Kp index
...
% ionosphere and its related effects
