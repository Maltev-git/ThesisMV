...
% viscous functions
viscous functions\\
Newell: $n^{1/2} \cdot v^2$\\



One physical quantity reflects the coupling intensity between solar wind and the magnetosphere: the dayside reconnection rate.\\

----------------\\


there are functions approximating the reconnection rate depending on the clock angle\\
- v: the solar wind velocity represents the rate at which IMF field lines are convected toward the magnetopause \citep{Newell2007}\\
Bz\\
...
The amount of flux opened is clearly proportional to BT\\


The rate magnetic flux is opened at the magnetopause $\text{d}\Phi / \text{d}t$.\\


The rate magnetic flux is opened at the magnetopause is a function of four factors, namely the rate at which field lines are convected toward the magnetopause, the probability that they subsequently merge, the strength of the IMF (and thus the amount of flux opened), and the length of the merging line along the magnetopause. \citep{Newell2007}\\
