...
--> proton plasma --> solar wind bulk properties for protons\\
electrically neutral\\
The electron and proton number densities have the same values in an ideal neutral hydrogen plasma.\\


The properties of solar wind are highly variable in time and space. The properties are determined by the values of the solar-wind parameters magnetic field strength, proton velocity, density, and temperature. Solar-wind quantities, such as particle flux densities, mass flux and plasma beta are derived from these four parameters. Their average magnitudes scale with solar activity, heliographic latitude, and solar distance. At a solar distance of Earth however, most of the time the parameter's typical values lie in the ranges \SIrange{3}{8}{\nano\tesla}, \SIrange{300}{500}{\km\per\s}, \SIrange{2}{8}{\per\cm\cubed}, and \SIrange{e4}{e5}{\K} (\citet[p.~92]{Kivelson1995}; \citet{Venzmer2017}). Having parameters in these ranges, the solar wind is a plasma with a beta in the range xx--xx.\\
mass flux...\\

sw density considerations:\\
1 liter air @ 1 bar (need 24 ms for passing 1 dm2 area @ 15 km/h)\\
equals\\
5.4e6 km3 = (175 km)3 solar wind @ 5.4 cm-3 (need 43900 a for passing 1 dm2 area @ 400 km/s)\\
...
\citet{Schwenn1983}: ``During the Skylab era in 1973/74 we learned that these high speed streams emerge from coronal holes \citep{Krieger1973,Hundhausen1977}.''\\
