...
The helicity and initial orientation of the magnetic flux rope structure within a CME are inferred from the “Bothmer-Schwenn” scheme. This relates the flux rope properties to sunspots, the solar cycle, and whether the CME originates on the northern or southern solar hemisphere \citep{Bothmer1998}. The reliability of this solar hemispheric rule remains controversial. It was only in late 2013 when the probability of active region's topology conforming to the hemispheric rule was reconfirmed to be GT 80\% \citep{Wang2013}; Hale, 1925]. Thus,the initial helicity and field structure of CMEs can be inferred from this scheme with a reliability that is likely to be 80\%. from Savani2015\\
