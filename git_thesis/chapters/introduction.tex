...
Some general solar wind tendencies can be seen from this plot: The solar-wind temperature scales with the stream velocity; compressed plasma regions enhance the magnetic field and the density; magnetic sector boundaries, HCSs, and MCs come with high densities and low temperatures; MCs in CMEs have high magnetic fields and low temperatures. I indicated the periods of solar wind structures, that is, HSSs, CIRs, HCSs, and CMEs, with colored bars -- they are further described in the following sections.\\
...
Recurrent HSSs of the same field polarity but changing peak velocity exist in this period (e.g., beginning on 6~May, 2~June, and 29~June).\\
...
describe in-situ signatures of CIRs; in-situ CIR/HSS plot, see \autoref{fig:ACE_64s_v7_thesis_CIRs_2013-5-1_65_plot}\\
