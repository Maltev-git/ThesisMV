...
\begin{itemize*}
	...
	\item Turbulence, due to Kelvin-Helmholtz (KH) instability created from solar wind drag at the flanks of the magnetosphere.
	
	\citep{Alfven1942} viscous interaction (of turbulent nature) is a viable source of drag force/solar storm energy input into magnetosphere\\
...
\citep{Otto2003} KH instabilities/vortices force magnetic reconnection even at northern IMF and are able to account for observed mass flux\\
...
Its location on the magnetopause shifts depending on the IMF direction. two extreme cases of Bz orientation
\\
during northern IMF parallel\\
during southern IMF antiparallel\\
half-wave rectifier\\
