...
HCS from sector boundaries? (ballerina skirt)\\
equatorial ballerina model -> CIRs (figure?)\\


% heliospheric current/plasma sheets
...
stream interface between streams in the middle of HCS/HPS?\\
