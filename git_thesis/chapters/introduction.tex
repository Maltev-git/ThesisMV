...
paperMVVB:\\
"From observations of cometary tail fluctuations, Biermann (1951) inferred the presence of a continuous flow of particles from the Sun. With his theoretical solar-wind model, Parker (1958) formulated the existence of the solar wind even before the first satellites measured it in situ in 1959 (Gringauz et al. 1960; Neugebauer \& Snyder 1966)."\\
...
Plasma in general (properties (H/He/metal composition; see paper...), Plasma-beta, etc.)\\
	solar-wind properties, slow/fast wind, MHD waves (Alfvén waves)\\
