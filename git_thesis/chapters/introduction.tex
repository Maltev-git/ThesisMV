...
\begin{figure}[htb]
	\begin{floatrow}
		...
		\ffigbox{
			...
			\caption{A simple HCS model, where its wavy surface shape solely stems from a dipole tilt of \SI{15}{\degree} to the rotation axis. Credit: \citep[Fig.~2]{Jokipii1981}, \textcopyright~AAS, permission?...}
...
%first white-light observations
...
describe what is seen where in the picture \\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
...
% BSS
MCs are magnetic flux ropes (MFR)\\
