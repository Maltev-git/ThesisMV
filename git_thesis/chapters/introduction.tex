...
After the reconnection at the sunward magnetopause, the previously closed magnetospheric field lines are open to the IMF. They are still connected to one of the poles, but their IMF part is transported by the flow of the solar wind. The lines are stretched behind Earth and form eventually the extended magnetotail, where in its central plane reconnection recloses the fields. The closed field lines migrate around the flanks of the magnetosphere to its front again, completing one magnetic convection cycle induced by the solar wind \citep{Dungey1961,Dungey1963}.\\

The course of this so-called Dungey convection cycle is illustrated in \autoref{fig:Kivelson1995_fig9_11_dungey_cycle}. The Dungey cycle imprints a twin-cell convection pattern in the polar ionospheric plasma, where the footpoints of the geomagnetic field lines are swept from the day- to the nightside and wander back again along the dusk and dawn lower latitudes.\\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		{Dungey's magnetic convection cycle illustrated in a cut through the magnetosphere (top) and on the two-cell ionosphere polar cap (bottom). The numbers on the magnetic field lines (arrowed lines) correspond to the numbered positions in the twin-cell polar cap convection cycle. Credit: {\citet[Fig.~9.11]{Hughes1995}}, \textcopyright~Cambridge University Press, get permission...}
...
There plasmoids are created that are carried away with the solar wind.
...
This concept naturally explains several known features of the magnetosphere, such as the presence of an extended magnetotail [e.g., Wolfe et al., 1967], erosion of the dayside magnetopause during periods of southward interplanetary magnetic field (IMF) [e.g., Aubry et al., 1970; Holzer and Slavin, 1979], and the twin-cell ionospheric convection pattern [e.g., Cowley and Lockwood, 1992].
...
% auroral ovals
The boundary between open and closed field connects to the polar regions...\\
