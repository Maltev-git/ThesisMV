...
As MCs are the drivers for most severe geomagnetic disturbances \citep{Cane2003}, it is also important to forecast their magnetic field strength and configuration.\\

An early 3D model for a general CME geometry is the ice-cream cone model, which assumes a bubble-like CME structure \citep{Fisher1984}. Though, building on the the study by \citet{Cremades2004}, \citet{Thernisien2006} created the more complex graduated cylindrical shell (GCS) model for flux rope-like CMEs.\\

Fast CMEs decelerate substantially due to the drag force with the solar wind already during their first few solar radii \citep{Sachdeva2017}.\\
...
% CME deflection
During and shortly after their eruption, CMEs are frequently observed to be deflected to other directions by the surrounding coronal magnetic field structure \citep{Sterling2011}.\\
% CME-CME interaction
the arrival of CMEs at 1 AU gets delayed when they interact with preceding CMEs \citep{Manoharan2004,Temmer2012}.\\
