...
the two polarities of the dipole being separated by the warped heliospheric current sheet (HCS) \citet{Owens2013}.\\
The large-scale regions of opposite HMF polarity are separated by the heliospheric current sheet (HCS) \citet{Owens2013}\\

Thus, spacecraft in near-Earth space will generally be close in heliolatitude to the HCS and will sample HMF polarities from both polar coronal holes as the Sun rotates \citet{Owens2013}.\\

%in situ observations
Periods of both two- and four-sector structures are seen. As the HCS is formed by open solar flux (OSF) of opposite polarities coming into contact by the non-radial expansion of separate coronal holes, the HCS maps to helmet streamers and is typically located within slow solar wind \citet{Owens2013}.\\
% sector boundaries
...
solar wind parameters including speed, temperature, density, and composition vary with distance from the HCS \citep{Smith2001}.\\
