...
There exist several spectrometer types with different energy ranges:\\

An isotope spectrometer -- isotopic abundances of SEPs\\
ionic charge analyzer - charge state of SEPs\\
solar wind ion mass spectrometer - \\
solar wind ion composition spectrometer - \\


ACE/SWEPAM-I \citep{McComas1998a}\\
% https://swepam.lanl.gov/
...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.5\textwidth]{figures_of_mine/gnuplots/ion_energy_spectrum_plot.pdf}
	}{
...
...read \urltext{http://www.goembel.biz/sun.html}\\
...
the ion spectrometer Solar Wind Electron, Proton, and Alpha Monitor (SWEPAM-I), see \autoref{fig:ACE_SWEPAM_I}\\
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		\includegraphics[width=0.5\textwidth]{figures_of_others/images/ACE_SWEPAM_I.jpg}
	}{
