...
The Helios data is used in \autoref{chap:empirical_solar_wind_model_for_the_inner_heliosphere} for analyzing the solar wind parameters' solar distance dependency.
