...
%%% history and plasma properties

before? see Kivelson1995, p14+91\\

first observed at solar eclipses? ...see eclipse photo from Druckmüller \autoref{fig:Tse2008_500_mo1}\\

Carrington from geomagnetic storms?\\

\citet{Biermann1951} inferred the presence of a continuous flow of solar particles from observations of cometary tail fluctuations.\\
...
Parker (1958) formulated the existence of the solar wind with his theoretical solar-wind model, even before the first satellites measured it in situ in 1959 \citep{Gringauz1960,Neugebauer1966}.\\


The solar wind is a plasma composed from protons and alphas.\\

solar-wind plasma composition and properties\\

- its properties are highly variable\\
- parameter magnitudes change with solar distance\\

the parameter ranges at Earth distance, He percentage\\
...
Solar-wind properties and structures\\
...
\begin{figure}[htb]
	\fcapside[\FBwidth]{
		...
		\caption{CME with MC. ACE data. find optimal event + remake figure...}
