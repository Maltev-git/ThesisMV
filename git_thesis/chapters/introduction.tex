...
\begin{itemize*}
	...
	\begin{figure}[htb]
		\fcapside[\FBwidth]{
			...
			{IMF clock angle ($\theta_c$) dependency of the coupling functions' relative amplitudes. The different functions include the IMF clock angle factor by \citet{Newell2007} and the half-wave rectifier (black). I added the GSM coordinate directions in the lower left for orientation.}
...
\section{Solar wind spectrometer}
\label{sec:solar_wind_spectrometer}
