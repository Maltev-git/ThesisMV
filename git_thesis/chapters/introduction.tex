...
\end{figure}
In coronal regions with closed magnetic field lines the plasma is trapped, though in CHs it can escape following the open magnetic field lines outwards into space. Superradial expansion of the magnetic field lines in the corona has an influence on the wind speed, actually the expansion factor is anticorrelated with the final wind velocity. As near the border of CHs the field expansion is larger, faster wind emerges from the mid regions of CHs, forming into HSSs. However, there are indications that the slow and fast solar wind are not only generated at different sources but from distinct mechanisms \citep{McGregor2011b}.

%sources of slow solar wind
The high variability in the slow solar wind points to the existence of different types of slow wind flows, originating from separate coronal locations and mechanisms \citep{Schwenn1983}, which are still under debate. Studies using remote white-light tracing of coronal material and in-situ measurements of solar wind suggest that multiple sources of slow solar wind flows exist \citep{Wang2000,Kilpua2016}. To the best of my knowledge all the considered sources are listed in the following:
\begin{itemize*}
	...
	\item Helmet/pseudo-streamers, where transient plasma blobs are released. Slow dense material, forming the HPS belt...
	\item Edges of active regions, with hot outflows with speeds up to ∼100~km/s, first reported by Kojima1999...
...
tracing slow solar wind sources with the specific entropy\\
...
introduce next section: sector boundaries, stream interfaces, interaction regions...\\
...
Borrini et al. (1981) had found significant depletions in $n_alpha/np$ around magnetic sector boundaries which are normally imbedded in slow solar wind.\\
