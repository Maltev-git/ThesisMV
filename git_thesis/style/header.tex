\documentclass[twoside,openright,fontsize=10pt,a4paper]{scrreprt}
\KOMAoptions{headings=normal,numbers=noendperiod,toc=bib,cleardoublepage=plain,abstract=false}
...
\usepackage[inner=3cm,outer=2.5cm,top=2.5cm,bottom=2.5cm]{geometry}	% showframe

% \widowpenalty=300	% lonely last line of paragraph
% \clubpenalty=300	% orphan or lonely first line of paragraph
...
% \pdfsuppresswarningpagegroup=1	% not working at university PC
...
\newcommand{\urlfoot}[1]{{\scriptsize{\url{#1}}}}	%monospace seems larger than normal text - this adapts the url textsize for footnotes
\newcommand{\urltext}[1]{{\small{\url{#1}}}}	%monospace seems larger than normal text - this adapts the url textsize for footnotes
...
\hypersetup{
	...
	urlcolor = blue,
	pdfinfo={
		Title={Dissertation - Malte Venzmer - 2018},
		Subject={Solar wind},
		Author={Malte S. Venzmer},
		Keywords={Sun, solar wind, coronal mass ejections, magnetosphere, space weather, Helios, Parker Solar Probe}
	},
...
\citestyle{aa}
\setlength{\bibsep}{4pt plus 0.3ex}	% reset \bibsep (separating space between reference entries)
...
\usepackage{enumitem}
\setlist[description]{font=\normalfont, noitemsep, labelwidth=1.7cm}
...
\lstset{
  ...
  tabsize=3,
	extendedchars=true,
	literate={ä}{{\"a}}1 {Ä}{{\"A}}1 {ö}{{\"o}}1 {Ö}{{\"O}}1 {ü}{{\"u}}1 {Ü}{{\"U}}1 {á}{{\'a}}1 {í}{{\'i}}1 {é}{{\'e}}1 {ů}{{\r{u}}}1 {ř}{{\v{r}}}1 {ě}{{\v{e}}}1
}

% list of figures thumbnails
\newlength{\lofthumbsize}
\setlength{\lofthumbsize}{4em}
\newif\iflofimage
\DeclareRobustCommand*{\lofimage}[2][]{
  \iflofimage
    $\vbox to \lofthumbsize{\vss
