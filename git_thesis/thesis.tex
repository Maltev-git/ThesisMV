...
\begin{document}	%use input instead of include...
	\pagenumbering{Roman}
	\include{chapters/cover}		%cover_formal
	\pagenumbering{arabic}
	\include{chapters/introduction}		%introduction, basics and data
%	\include{chapters/data}

	%####--  Chapter2  --####
	\include{chapters/chapter2_wrapper}

	%####--  PaperMVVB  --####
	\include{chapters/paperMVVB_wrapper}
	%\bibliography{paperMVVB/sections/literature_bibtex}
	%\includepdf[pages=-]{paperMVVB/paperMVVB_without_bold.pdf}

	\include{chapters/analyses_helios}
	\include{chapters/analyses_helios_lineup}
	\include{chapters/results}
	\include{chapters/summary}	%summary and conclusions

	\appendix
	\include{appendix/physics}	%theory & calculations
	\include{appendix/math}		%definitions, methods, calculations
	...
	\bibliography{appendix/literature_bibtex,appendix/literature_bibtex_custom_entries,paperMVVB/sections/literature_bibtex}	%style/mn-jour, style/apj-jour
