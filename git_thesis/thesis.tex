...
\begin{document}
	...
	%####--  Chapter2  --####
	\input{chapters/chapter2_wrapper}

	\input{chapters/analyses_omni}
	...
	\input{chapters/analyses_helios_lineup}
	\input{chapters/discussion_summary}

	\appendix
	\input{appendix/physics}	%theory & calculations
	\input{appendix/math}		%definitions, methods, calculations
