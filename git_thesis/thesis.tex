...
\begin{document}
	...
	\input{chapters/introduction}		%introduction, basics and data
	...
	\bibliographystyle{style/apj_modified_v4}	%style/mn, style/astron, plain, plainnat, style/apj, alpha, abbrv, style/apj_modified_v1 (new one)
